...
try
    ...
    dotParams.gToleranceDeg     = 0.01;  % 허용 오차 (°)
    ...
    timingParams.stimDurationMs    = 200;   % T1/T2 자극 제시 시간
    ...
    presentBlank(dp, timingParams.postTrialMs, kb);
